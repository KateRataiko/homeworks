...
function handle() {
    let fio = document.getElementById('first_name');
    first_name.value = first_name.value.replace(/[^А-Яа-яЁё ]/g, "");
  }
    let input = document.getElementById('first_name');
    input.onkeydown = input.onkeyup = input.onkeypressonkeypress = handle;
